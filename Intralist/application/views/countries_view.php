...
<h1>Πίνακας ευρωπαϊκών χωρών-μελών</h1>

<div id="countries_view">
<p>
	<?php
		//echo $this->table->set_caption('');
		echo $this->table->set_heading('Κωδικός χώρας','Όνομα χώρας'); 
	  ...
	  $tmpl = array (
		...
		echo $this->table->generate($countries_table);
	?>	
</p>
</div>