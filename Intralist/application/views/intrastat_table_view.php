	...
	<h1>Intrastat Table</h1>
<div id="intrastat_table_view">
<p>
	<?php

		//echo $this->table->set_caption('');
		echo $this->table->set_heading('Χώρα','Δασμ/κή κλάση','Καθαρή μάζα','Μονάδες','Αξία τιμολογίου'); 
		...
		echo $this->table->generate($intrastat_table);
	?>
